...
# upload data for DIP_2 and CDP_2
DIP2_overall = read.csv("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/DIP_2/target_0.3/DIP2_0.3_overall.csv")
DIP2_mean = as.numeric(DIP2_overall[1,-1])

CDP2_overall = read.csv("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/CDP_2/target_0.3/CDP2_0.3_overall.csv")
CDP2 = as.numeric(CDP2_overall[1,-1])
...
DIP2_mean_aboveMTD = as.numeric(DIP2_overall[2,-1]); DIP2_mean_aboveMTD[is.na(DIP2_mean_aboveMTD)] = 0
CDP2_aboveMTD = as.numeric(CDP2_overall[2,-1]); CDP2_aboveMTD[is.na(CDP2_aboveMTD)] = 0
...
ggsave("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/target0.3_temp2.png",plot = p1, width = 8,height = 8,dpi = 600)
...
df3 <- data.frame(
  Scenario = scenarios,
  DIP_nonflat = DIP2_mean_aboveMTD,
  CDP_nonflat = CDP2_aboveMTD,
  BOIN = BOIN_aboveMTD
)
...
plot_0.3 <- (p1 | p3) + 
  ...
  theme(legend.position = "bottom")  # place one legend at bottom
...
#save the image
ggsave("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/target0.3_nonflat.png",plot = plot_0.3, width = 8,height = 4,dpi = 600)
...
# upload data for DIP_2 and CDP_2
DIP2_overall = read.csv("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/DIP_2/target_0.2/DIP2_0.2_overall.csv")
DIP2_mean = as.numeric(DIP2_overall[1,-1])

CDP2_overall = read.csv("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/CDP_2/target_0.2/CDP2_0.2_overall.csv")
CDP2 = as.numeric(CDP2_overall[1,-1])
...
#save the image
ggsave("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/target0.2_nonflat.png",plot = plot_0.2, width = 8,height = 4,dpi = 600)
...
# upload data for DIP_2 and CDP_2
DIP2_overall = read.csv("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/DIP_2/target_0.25/DIP2_0.25_overall.csv")
DIP2_mean = as.numeric(DIP2_overall[1,-1])

CDP2_overall = read.csv("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/CDP_2/target_0.25/CDP2_0.25_overall.csv")
CDP2 = as.numeric(CDP2_overall[1,-1])
...
#save the image
ggsave("C:/Users/shokouhinid/sstp_2023_Wages/Dr. wages_code_final results/final_results_02172026/target0.25_nonflat.png",plot = plot_0.25, width = 8,height = 4,dpi = 600)
